...
mission      : Touring
origin_locn  : Essaouira
origin_moor  : Fishing Port
destination  : 
...
crew         : Esteban
skipper      : Boran
gps_track    : https://connect.garmin.com/modern/activity/21717169451
photos       : https://photos.app.goo.gl/6ToqmcDCtoyxWT8x9
---
...
1. Monday
    ...
    We drill new holes for the mount of the autohelm's wheel drive, which gives better tension on the belt. Autohelm can now steer up to 5 or 6 knots speed through water and a well balanced sail plan (typically with the aftsail travelled leeward).
...
2. Tuesday
    ...
    Noise in the hulls increases. Sounds like wood under high stress. Likely the steel bolts through the crossbeams. Borans finds that most crossbeams are lifting with wave action. Higher alertness to use the rescue island. We keep speed at 3-5 knots while still sailing upwind in fresh conditions.

    During the night excellent electric charging with wind power, from 46% to 58% SOC.
...
3. Wednesday
    ...
    Boran installs a nicer manual swith for the starboard navlight. A manual override is useful anyway, even when the light will be automated again in the future.
...
5. Friday
    ...
    Boran installs more "breathing" bungee lines in the midsail mainsheet and the aftsail 
...
7. Sunday (for the sake of completeness)

    Changing to anchor in the bay just South of the port.
